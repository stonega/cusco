...
LCP is a Core Web Vital that directly affects user experience and search ranking. The LCP element is often an image; identify it in the trace before choosing a fix.
...
For additional context, read [LCP breakdown](references/lcp-breakdown.md),
[eligible elements and sizing](references/elements-and-size.md), or
[optimization strategies](references/optimization-strategies.md) as needed.
