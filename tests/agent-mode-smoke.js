...
if (!nativeToolPrompt.includes('native function-calling interface')
    ...
    || !nativeToolPrompt.includes('one computer_step type action with x, y, and text')
    || !nativeToolPrompt.includes('Never batch an explicit coordinate click with typing')
